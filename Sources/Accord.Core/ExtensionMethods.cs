...
public static class ExtensionMethods
{
    ...
    /// <summary>
    ///   Creates and adds multiple <see cref="DataColumn"/>
    ///   objects with the given names at once.
    /// </summary>
    /// 
    /// <param name="collection">The <see cref="DataColumnCollection"/>
    ///   to add in.</param>
    ...
    public static object To(this object value, Type type)
    {
        ...
        if (type.IsEnum)
#endif
            return Enum.ToObject(type, (int)Convert.ChangeType(value, typeof(int)));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
    static IntPtr AddressOfRef<T>(ref T t)
    {
        unsafe
        {
            TypedReference reference = __makeref(t);
