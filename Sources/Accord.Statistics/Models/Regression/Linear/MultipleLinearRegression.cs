...
#pragma warning restore 612, 618
{
    ...
    [Obsolete]
    private readonly bool addIntercept;
    ...
    public override int NumberOfInputs
    {
        ...
        set
        {
            ...
            coefficients = Vector.Create(value, coefficients);
        }
    }
    ...
    public virtual double Regress(double[][] inputs, double[] outputs, bool robust)
    {
        if (inputs.Length != outputs.Length)
            throw new ArgumentException("Number of input and output samples does not match", nameof(outputs));
        return Regress(inputs, outputs, out double[,] _, robust);
    }
    ...
    public virtual double Regress(double[][] inputs, double[] outputs)
    {
        if (inputs.Length != outputs.Length)
            throw new ArgumentException("Number of input and output samples does not match", nameof(outputs));
        return Regress(inputs, outputs, out _, true);
    }
    ...
    public double Regress(double[][] inputs, double[] outputs,
        out double[,] informationMatrix, double[,] design, bool robust = true)
    {
        if (inputs.Length != outputs.Length)
            throw new ArgumentException("Number of input and output samples does not match", nameof(outputs));
    ...
    /// 
    public static double[] GetStandardErrors(double mse, double[][] informationMatrix)
    {
    ...
    /// 
    public static double GetStandardError(double[] input, double mse, double[][] informationMatrix)
    {
    ...
    /// 
    public static double GetPredictionStandardError(double[] input, double mse, double[][] informationMatrix)
    {
        double rim = PredictionVariance(input, informationMatrix);
    ...
    {
        return new double[] { Compute(inputs) };
    }
